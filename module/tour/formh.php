<?php
                        if (isset($_POST["ok"])) {
                            if ($_POST["checkin"] == null or $_POST["checkout"] == null or $_POST["adult"] == null or $_POST["kid"] == null or $_POST["name"] == null or $_POST["tell"] == null or $_POST["txtCaptcha"] == null or $_POST["email"] == null) {
                                $err = 1;
                       ...
                       <!-- name-->
                         <div class="col-md-10">
                          ...
                          <div class="form-group">
                              <label for="name">
                                 Date:</label>
                         <input class="form-control" placeholder="Date" id="checkin" name="checkin"  type="text"/>
                                <script>
