<div class="" style="margin-top: 20px;">
    <div style="width:100%; border:none;">
        ...
        <div class="md_thanhtd" ">
            <div style="font-size:18px; font-weight: bold; text-align: center; color:#fff; padding-top:6px">OTHER TOUR</div>
        </div>
        <!-- dong tieu de -->
        <div style=" margin-top: 10px; background: #16450221;">
            <?php 
                    ...
                    $tv2 = mysql_query($kn2);
                     while ($kq2= mysql_fetch_array($tv2)) { 
                        ...
                        $id2 = $kq2['id'];
                ?>
            <div class="tour_text_right"><a href="detail.php?id=<?=$id2?>/#detail"><?=$sp2?></a></div>
...
<div class="zoom" style="float: left; margin-right: 5px;"><a href="#"><img src="<?=$path?>/layout/images/trip.png" alt="" width="35" height="35"></a></div>
    ...
    <!-- video -->
        ...
        <div style="margin-top:10px">
            <iframe width="100%" height="150px" src="https://www.youtube.com/embed/X-7NXxWRkm0" frameborder="0" allowfullscreen=""></iframe>
        </div>
    </div>
    <!--dong  video -->
    <div style="height:20px; clear:both"></div>
