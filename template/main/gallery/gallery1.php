<script src="js/jssor.slider-27.1.0.min.js" type="text/javascript"></script>
    <script type="text/javascript">
        jssor_133_slider_init = function() {

            var jssor_133_options = {
              $AutoPlay: 1,
              $AutoPlaySteps: 1,
              $SlideDuration: 160,
              $SlideWidth: 300,
            ...
            var jssor_133_slider = new $JssorSlider$("jssor_133", jssor_133_options);
            ...
            function ScaleSlider() {
                var containerElement = jssor_133_slider.$Elmt.parentNode;
                ...
                if (containerWidth) {
                    ...
                    jssor_133_slider.$ScaleWidth(expectedWidth);
                }
                else {
    ...
    <div id="jssor_133" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:300px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
    ...
    <script type="text/javascript">jssor_133_slider_init();</script>